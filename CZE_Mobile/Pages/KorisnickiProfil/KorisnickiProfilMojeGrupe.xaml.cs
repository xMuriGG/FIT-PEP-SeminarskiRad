...
namespace CZE_Mobile.Pages.KorisnickiProfil
{
    ...
    /// </summary>
    public sealed partial class KorisnickiProfilMojeGrupe : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        WebAPIHelper mojaGrupaService = new WebAPIHelper(Global.GetMessage("route"), "Api/GrupaKandidati/MojeGrupe");
        HttpResponseMessage response;

        public KorisnickiProfilMojeGrupe()
        {
